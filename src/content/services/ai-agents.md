...
An AI agent is a small piece of software with a specific job, access to your information, and permission to take a narrow set of actions. Not a chatbot that guesses, and not a replacement for your team — a tool that handles the routine so people can handle the rest.

The distinction that matters: a good agent knows what it does not know and hands off cleanly.

## Agents we build

- **Customer question handling.** Answering the same fifteen questions your team answers every week — hours, policies, availability, what you do and do not offer — from your actual information rather than a guess.
