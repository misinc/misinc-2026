...
The case for moving is specific: **you already take payments through Square in person.** If you do, running Shopify online and Square at the counter means two catalogues, two inventory counts, two sets of fees, and a reconciliation job that somebody does every month. Consolidating removes all of that.

If you do not use Square in person, most of the reason to move disappears.

## When Square Online is the better fit

- You run a **restaurant, café, or bar** — online ordering, curbside pickup, and local delivery are built in, and they connect to the same Square hardware taking counter orders.
- You have a **modest catalogue** — tens or low hundreds of items rather than thousands.
...
- **Large or complex catalogues** — thousands of SKUs, deep variant structures, or complicated inventory rules.
...
**Products** — titles, descriptions, images, variants, and prices — come across, along with **collections**, mapped to Square's category structure. **Customer records** transfer, though customers set new passwords, and **order history** comes across as records for reference rather than as live orders. **Content pages** are rebuilt in the new site, and **every product and collection URL** is redirected, because product pages are frequently the ones carrying search traffic.

## What you should expect to lose

Any Shopify app without a Square equivalent, some checkout customisation, and some of the reporting depth. Themes do not convert — the storefront is rebuilt.
...
Most Shopify to Square migrations take two to four weeks, depending on catalogue size.
