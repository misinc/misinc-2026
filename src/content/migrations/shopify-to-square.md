...
- You have a **modest catalogue** of tens or low hundreds of items rather than thousands.
...
- **Large or complex catalogues** of thousands of SKUs, deep variant structures, or complicated inventory rules.
...
Any Shopify app without a Square equivalent, some checkout customisation, and some of the reporting depth. Themes do not convert, so the storefront is rebuilt.
