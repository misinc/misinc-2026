...
We have done enough of these that the process is settled:
...
No plugin updates and no security patching. Hosting, CDN, and SSL included rather than assembled. A visual editor that produces clean markup instead of nested builder divs. Genuinely fast pages without a caching stack. And a design you can change without a developer, which is the part clients notice first.
...
Most WordPress migrations run four to eight weeks and are priced on the size of the site and how much custom functionality has to be rebuilt. A ten-page marketing site is straightforward. Two hundred posts and three custom post types is a bigger piece of work.

We quote a fixed price after looking at the actual site. See the [pricing guide](/albuquerque-web-design-pricing-guide) for the ranges we work within.
