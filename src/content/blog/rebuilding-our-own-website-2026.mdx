...
summary: "After 31 years in business and about 18 months of putting it off, we rebuilt misinc.com from scratch with a new framework, published prices, and no advertising or analytics tracking."
date: 2026-08-17
image: /img/blog/misinc-2026-new.jpg
guide: false
seo:
  title: "We Rebuilt Our Own Website in 2026 | MIS, Inc."
  description: "Why MIS, Inc. rebuilt misinc.com in 2026, chose Astro for itself and Webflow for many clients, preserved important URLs, published prices, and removed analytics tracking."
faqs:
...
The new site has no Google Analytics, no advertising pixels, and no first-party tracking cookies. The fonts and the map on the contact page are served from our own site rather than Google’s.
...
The Cal.com booking tool on the free consultation page is the exception. It loads only on that page and may set its own cookies. Cloudflare may also set a security cookie. Our [privacy policy](/privacy-policy) describes those exceptions and what the site actually does.
